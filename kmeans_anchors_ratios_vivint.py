...
"""
Vivint data example usage:
python kmeans_anchors_ratios_vivint.py --instances ../mscoco_test.json --anchors-sizes 32 64 128 256 512 \
                                        --input-size 320 --normalize-bboxes True --num-runs 3 --num-anchors-ratios 3 \
                                        --max-iter 300 --min-size 0 --iou-threshold 0.5 --decimals 1
